...
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20.66682&lon=-103.39182&appid=dfbb6d3a6dc1959624e1c321c997188a&units=metric";


// ThingSpeak
uint32_t channelNumber = 2720840;
const char *writeAPIKey = "EVX7167YFSC2HDGV";
...
void sendDataToThingSpeak(){
    ...
    int code = ThingSpeak.writeFields(2720840, "EVX7167YFSC2HDGV");
    if(code == 200)
